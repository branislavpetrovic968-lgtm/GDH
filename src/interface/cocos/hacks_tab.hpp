...
public:
    ...
    void addConfigIntInput(const std::string& label, const std::string& key, int defaultValue = 0, std::function<void(int)> callback = nullptr);
    void addConfigFloatInput(const std::string& label, const std::string& key, float defaultValue = 0.f, std::function<void(float)> callback = nullptr);
