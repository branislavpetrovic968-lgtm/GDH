...
namespace ImGuiH {
    ...
    bool Button(const char* label, const ImVec2& size_arg)
    {
        ...
        const ImVec4 col_txt_idle = ImColor(26, 26, 73).Value;
        const ImVec4 col_txt_hov = ImColor(36, 36, 90).Value;
        const ImVec4 col_txt_held = ImColor(18, 18, 55).Value;
        const ImVec4 col_border  = ImColor(0, 0, 0,0).Value;
    ...
    bool Checkbox(const char* label, bool* v)
    {
        ...
        const ImVec4 col_bg_off = ImColor(71, 71, 131).Value;
        const ImVec4 col_bg_off_hov = ImColor(104, 104, 191).Value;
        const ImVec4 col_bg_off_held = ImColor(55, 55, 110).Value;
        const ImVec4 col_bg_on = ImColor(213, 196, 255).Value;
        const ImVec4 col_bg_on_hov = ImColor(228, 215, 255).Value;
        const ImVec4 col_bg_on_held = ImColor(185, 165, 240).Value;
        const ImVec4 col_knob_off = ImColor(199, 212, 250).Value;
        const ImVec4 col_knob_off_hov = ImColor(224, 235, 255).Value;
        const ImVec4 col_knob_off_held = ImColor(148, 158, 210).Value;
        const ImVec4 col_knob_on = ImColor(33, 33, 78).Value;
        const ImVec4 col_knob_on_hov = ImColor(46, 46, 99).Value;
        const ImVec4 col_knob_on_held = ImColor(22, 22, 58).Value;
        const ImVec4 col_border = ImColor(0, 0, 0, 0).Value;
    ...
    void Tooltip(const char* text, bool hovered)
    {
        ...
        const ImVec4 col_bg = ImColor( 33,  33,  78).Value;
        const ImVec4 col_border = ImColor(213, 196, 255).Value;
        const ImVec4 col_text = ImColor(213, 196, 255).Value;
